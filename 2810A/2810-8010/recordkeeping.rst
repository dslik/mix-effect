...
.. _tbl_2810_record_keeping:

.. list-table:: 2810A record keeping
    :class: longtable
    :header-rows: 1
    :align: center 
    ...
    * - 8.1.5
      ...
      - 
        .. raw:: latex
          ...
          \includegraphics[align=t,scale=1]{../../images/doc_stamp.pdf}
    * - 8.1.6
      - Add an entry to the assembly records binder, "<Date> - 2810A - SN# AAAAAA - <Your Name>", where <Date> is replaced with today's date in ISO-8601 YYYY-MM-DD, where AAAAAA is replaced with the serial number of the 2810A, and where <Your Name> is replaced with your first and last name.
      - 
        .. raw:: latex
