# 2810A Assembly Manual

This repository contains the source files used to build document number 2810-8010, the 2810A Assembly manual.
...
15. From the Mac Terminal, in the 2810A-master directory, cd into the docs/assembly directory
16. Run `make latexpdf` to build the document
16. Run `open _build/latex/2810-8010.pdf` to open the newly built PDF
